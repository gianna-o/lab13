	...
	public void setUp() throws Exception 
	{
		// instantiate an instance of lab13
				...
				try
				{
					...
					ArrayList<Integer> currentTestData0 = testData.get(0);
					expectedResult1 = new Integer[testData.get(0).size()];
					for(int i = 0; i < currentTestData0.size(); i++)
					{
						expectedResult1[i] = currentTestData0.get(i);
					}
					...
					ArrayList<Integer> currentTestData1 = testData.get(1);
					expectedResult2 = new Integer[testData.get(1).size()];
					for(int i = 0; i < currentTestData1.size(); i++)
					{
						expectedResult2[i] = currentTestData1.get(i);
					}
					...
					ArrayList<Integer> currentTestData2 = testData.get(2);
					expectedResult3 = new Integer[testData.get(2).size()];
					for(int i = 0; i < currentTestData2.size(); i++)
					{
						expectedResult3[i] = currentTestData2.get(i);
					}
